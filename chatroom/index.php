...
<body>
    ...
    <div class="body">
        ...
        <div class="chat_info collapse">

        <div class="chat_info_header"></div>

        <div class="chat_info_control">
            <div>1</div>
            <div>2</div>
            <div>3</div>
        </div>
            
        <div class="chat_info_field_wrapper">
            <div class="chat_info_field">
                <span>相片</span>
            ...
            <!-- <div class="chat_header">
                <div class="chat_header_chat_name">
                    <div  class="position-relative">
                        <img src="＃" alt="X" class="room_photo user_img">
